...
void PoincareView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        case 0:
            ...
            break;
        case 1:
            _t->zoom((*reinterpret_cast<ZoomType(*)>(_a[1])));
            break;
        case 2:
            _t->toggleLayer((*reinterpret_cast<int(*)>(_a[1])), (*reinterpret_cast<bool(*)>(_a[2])));
            break;
        case 3:
            _t->toggleFrame((*reinterpret_cast<bool(*)>(_a[1])));
            break;
        case 4:
            _t->animPlay();
            break;
        ...
        case 9:
            ...
            break;
        case 10:
            _t->pan((*reinterpret_cast<PanType(*)>(_a[1])));
            break;
        default:;
        }
    }
...
const QMetaObject PoincareView::staticMetaObject = {
    {&QCanvasView::staticMetaObject, qt_meta_stringdata_PoincareView,
     qt_meta_data_PoincareView, &staticMetaObjectExtraData}};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PoincareView::getStaticMetaObject()
{
...
void *PoincareView::qt_metacast(const char *_clname)
{
    ...
    return QCanvasView::qt_metacast(_clname);
}

int PoincareView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QCanvasView::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod)
    {
